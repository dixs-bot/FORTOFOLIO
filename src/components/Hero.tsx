    ...
    <section id="about" className="relative overflow-hidden pt-32 pb-24 md:pt-40 md:pb-32 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-950/40 via-slate-950 to-slate-950">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 flex flex-col items-center">
        ...
        <motion.h1
          ...
          className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight whitespace-pre-line"
        >
          Halo, Saya{" "}
          ...
          <br />
          <span className="text-slate-200 text-xl sm:text-2xl md:text-3xl block mt-2 font-bold font-sans">
            {personalInfo.title}
          </span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="max-w-3xl mx-auto text-sm sm:text-base text-slate-400 mb-10 leading-relaxed font-sans"
        >
          {personalInfo.bio}
        </motion.p>
